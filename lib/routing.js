const config = require('./config.js'),
    ...
    connection = mysql.createConnection(config.forMySQLconnect),
    multer = require('multer'),
    fs = require('fs-extra'),
    storage = multer.diskStorage({
        destination: function (req, file, cb) {
            const dir = __dirname + '/../../../' + config.host + '/public_html/upload/' + req.params.user + '/new/' + req.params.name;
...
module.exports = function (app) {
    ...
    app.post('/check/upload/', function (req, res) {
        ...
        const dir = __dirname + '/../../../' + config.host + '/public_html/upload/' + user;
