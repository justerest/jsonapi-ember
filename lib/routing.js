const configMySQL = require('./confmysql.js'),
    ...
    storage = multer.diskStorage({
        destination: function (req, file, cb) {
            const dir = __dirname + '/../../kscript.ru/public_html/upload/' + req.params.user + '/new/' + req.params.name;
...
module.exports = function (app) {
    ...
    app.post('/check/upload/', function (req, res) {
        ...
        const dir = __dirname + '/../../kscript.ru/public_html/upload/' + user;
